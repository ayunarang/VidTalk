// mailTemplate.js
function send_mail(username, roomId) {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
      <div style="padding:2.2rem; background-color: #F9F9F9; max-width: 800px; text-align: center;" class="outer-container">
        <div style="background-color: white; padding:1.5rem; margin: 2.2rem;" class="mail-content-container">
          ...
          <p style="font-size: 1rem; text-align:left" class="mail-content">Your scheduled meeting is going to start in 30 minutes. Below is more information about this meeting:</p>
